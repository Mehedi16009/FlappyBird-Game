...
def delta_frame(args):
    pass


class Bird(pygame.sprite.Sprite):
    # this represents the bird should be controled by the player
...
class PipePair(pygame.sprite.Sprite):
    ...
    def __init__(self, pipe_end_img, pipe_body_img):
        ...
        total_pipe_body_piece = int(WIN_HEIGHT -
                                    3 * WIN_HEIGHT -
                                    3 * PipePair.PIECE_HEIGHT /
                                    PipePair.PIECE_HEIGHT

                                    )
        self.bottom_pieces = randint(1, total_pipe_body_piece)
        self.top_pieces = randint(1, total_pipe_body_piece)

        for i in range(1, self_bottom_pieces + 1):
            pieces_pos = (0, WIN_HEIGHT - i * PipePair.PIECE_HEIGHT)
    ...
    @property
    def rect(self):
        return Rect(self.x, 0, PipePair.PIECE_HEIGHT)

    def update(self, delta_frame=1):
        self.x -= ANIMATION_SPEED * frames_to_msec(delta_frame)
